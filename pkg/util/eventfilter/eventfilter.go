...
func ObjectChangedFromKarmada(oldObj, newObj *unstructured.Unstructured) bool {
	oldBackup := oldObj.DeepCopy()
	newBackup := newObj.DeepCopy()

	removeIgnoredFields(oldBackup, newBackup)

	removeFieldsModifiedByKarmada(oldBackup, newBackup)
...
// removeFieldsModifiedByKarmada Remove the fields modified by karmada's own components.
func removeFieldsModifiedByKarmada(oldBackup, newBackup *unstructured.Unstructured) {

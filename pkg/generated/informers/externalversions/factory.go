...
import (
	...
	command "github.com/karmada-io/karmada/pkg/generated/informers/externalversions/command"
...
func (f *sharedInformerFactory) Command() command.Interface {
	return command.New(f, f.namespace, f.tweakListOptions)
}

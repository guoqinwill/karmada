...
func hasBeenPropagated(hpa *autoscalingv2.HorizontalPodAutoscaler) bool {
	ppLabel, ppExist := hpa.GetLabels()[policyv1alpha1.PropagationPolicyUIDLabel]
	cppLabel, cppExist := hpa.GetLabels()[policyv1alpha1.ClusterPropagationPolicyUIDLabel]
	return (ppExist && ppLabel != "") || (cppExist && cppLabel != "")
}
